...
from src.python.sw.cgra.sa_pipeline.stage0_sa import Stage0SA
from src.python.sw.cgra.sa_pipeline.stage10_sa import Stage10SA
from src.python.sw.cgra.sa_pipeline.stage1_sa import Stage1SA
from src.python.sw.cgra.sa_pipeline.stage2_sa import Stage2SA
from src.python.sw.cgra.sa_pipeline.stage3_sa import Stage3SA
from src.python.sw.cgra.sa_pipeline.stage4_sa import Stage4SA
from src.python.sw.cgra.sa_pipeline.stage5_sa import Stage5SA
from src.python.sw.cgra.sa_pipeline.stage6_sa import Stage6SA
from src.python.sw.cgra.sa_pipeline.stage7_sa import Stage7SA
from src.python.sw.cgra.sa_pipeline.stage8_sa import Stage8SA
from src.python.sw.cgra.sa_pipeline.stage9_sa import Stage9SA
