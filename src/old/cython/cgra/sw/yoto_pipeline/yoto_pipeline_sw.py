from src.old.util.per_graph import PeRGraph
from src.old.util.per_enum import ArchType
from src.old.util.piplinebase import PiplineBase
from src.old.cython import Stage0YOTO
from src.old.cython import Stage1YOTO
from src.old.cython import Stage2YOTO
from src.old.cython import Stage3YOTO
from src.old.cython import Stage4YOTO
from src.old.util.util import Util
import multiprocessing as mp
import os
import time


class YotoPipelineSwOpt(PiplineBase):
    len_pipeline = 6
