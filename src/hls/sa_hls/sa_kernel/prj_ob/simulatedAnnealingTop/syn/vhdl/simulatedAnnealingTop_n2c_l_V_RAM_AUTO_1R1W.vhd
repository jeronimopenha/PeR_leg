...
entity simulatedAnnealingTop_n2c_l_V_RAM_AUTO_1R1W is 
    generic(
        MEM_TYPE        : string    := "auto"; 
        DataWidth       : integer   := 800; 
        AddressWidth    : integer   := 3;
        AddressRange    : integer   := 6;
        COL_WIDTH       : integer := 8;
        NUM_COL         : integer := 800/8
    ); 
    port (
...
architecture rtl of simulatedAnnealingTop_n2c_l_V_RAM_AUTO_1R1W is 
