# 1 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage2_sa_hls.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage2_sa_hls.cpp" 2
# 1 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage2_sa_hls.hpp" 1
...
# 5 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage2_sa_hls.hpp" 2
...
# 2 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage2_sa_hls.cpp" 2
...
#pragma HLS inline
 ...
 m_old_output.th_idx = m_new_output.th_idx;
    ...
    VITIS_LOOP_19_1: for (ap_int<8> i = 0; i < 4; i++)
    {
...
#pragma HLS unroll
 ...
 m_old_output.va[i] = m_new_output.va[i];
    ...
    ap_int<8> va[4] = {-1, -1, -1, -1};
    ap_int<8> vb[4] = {-1, -1, -1, -1};

    if (st1_node_a != -1)
    {
        VITIS_LOOP_62_2: for (ap_int<8> n = 0; n < 4; ++n)
        {
...
#pragma HLS unroll
 ...
 ap_int<8> idx = (st1_node_a * 4) + n;
    ...
    if (st1_node_b != -1)
    {
        VITIS_LOOP_79_3: for (ap_int<8> n = 0; n < 4; ++n)
        {
...
#pragma HLS unroll
 ...
 ap_int<8> idx = (st1_node_b * 4) + n;
    ...
    VITIS_LOOP_99_4: for (ap_int<8> i = 0; i < 4; i++)
    {
