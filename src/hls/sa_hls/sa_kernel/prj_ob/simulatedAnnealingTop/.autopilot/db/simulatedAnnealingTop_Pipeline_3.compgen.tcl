...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename n_l_V \
    op interface \
    ports { n_l_V_address0 { O 7 vector } n_l_V_ce0 { O 1 bit } n_l_V_we0 { O 4 vector } n_l_V_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'n_l_V'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln26 \
    op interface \
    ports { sext_ln26 { I 60 vector } } \
} "
}
