# 1 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage3_sa_hls.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage3_sa_hls.cpp" 2
# 1 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage3_sa_hls.hpp" 1
...
# 5 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage3_sa_hls.hpp" 2
...
# 2 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage3_sa_hls.cpp" 2

Stage3SaHls::Stage3SaHls()
{
    m_flag = true;

    VITIS_LOOP_7_1: for (ap_int<8> i = 0; i < 6; i++)
    {
...
#pragma HLS inline
 ...
 m_old_output.th_idx = m_new_output.th_idx;
    ...
    VITIS_LOOP_28_1: for (ap_int<8> i = 0; i < 4; i++)
    {
...
#pragma HLS unroll
 ...
 m_old_output.cva[i] = m_new_output.cva[i];
    ...
    ap_int<8> cva[4] = {-1, -1, -1, -1};
    ap_int<8> cvb[4] = {-1, -1, -1, -1};

    VITIS_LOOP_107_2: for (ap_int<8> n = 0; n < 4; ++n)
    {
...
#pragma HLS unroll
 ...
 if (st2_va[n] != -1)
    ...
    VITIS_LOOP_137_3: for (ap_int<8> i = 0; i < 4; i++)
    {
