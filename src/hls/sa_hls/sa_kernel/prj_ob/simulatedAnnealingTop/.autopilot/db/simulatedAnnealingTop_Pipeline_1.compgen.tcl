...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename n2c_l_V \
    op interface \
    ports { n2c_l_V_address0 { O 3 vector } n2c_l_V_ce0 { O 1 bit } n2c_l_V_we0 { O 100 vector } n2c_l_V_d0 { O 800 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'n2c_l_V'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_n2c_cast \
    op interface \
    ports { n2c_cast { I 4 vector } } \
} "
}
