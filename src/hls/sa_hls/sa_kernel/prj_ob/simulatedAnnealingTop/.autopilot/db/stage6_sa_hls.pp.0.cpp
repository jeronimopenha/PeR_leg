# 1 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage6_sa_hls.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage6_sa_hls.cpp" 2
# 1 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage6_sa_hls.hpp" 1
...
# 5 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage6_sa_hls.hpp" 2

class Stage6SaHls
{
private:
public:
    ST6_OUT m_new_output = {0, false, 0, 0, {0, 0}, {0, 0}};
    ST6_OUT m_old_output = {0, false, 0, 0, {0, 0}, {0, 0}};

    void compute(ST5_OUT st5_input);
};
# 2 "/home/jeronimocosta/Documentos/GIT/PeR/src/hls/sa_hls/sa_kernel/src/stage6_sa_hls.cpp" 2
...
#pragma HLS inline
 ...
 m_old_output.th_idx = m_new_output.th_idx;
    ...
    VITIS_LOOP_13_1: for (ap_int<8> i = 0; i < 4 / 2; i++)
    {
...
#pragma HLS unroll
 ...
 m_old_output.dvas[i] = m_new_output.dvas[i];
    ...
    VITIS_LOOP_34_2: for (ap_int<8> i = 0; i < 4 / 2; i++)
    {
