...
void Stage2SaHls::compute(ST1_OUT st1_input, ap_int<8> **n0, ap_int<8> **n1, ap_int<8> **n2, ap_int<8> **n3)
{
    ...
    if (st1_node_a != -1)
    {
        va[0] = n0[st1_node_a][0];
        va[1] = n0[st1_node_a][1];
        va[2] = n1[st1_node_a][2];
        va[3] = n1[st1_node_a][3];
    }
    if (st1_node_b != -1)
    {
        vb[0] = n2[st1_node_b][0];
        vb[1] = n2[st1_node_b][1];
        vb[2] = n3[st1_node_b][2];
        vb[3] = n3[st1_node_b][3];
    }
