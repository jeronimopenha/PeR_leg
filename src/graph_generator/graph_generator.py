...
class GraphGenerator:
    ...
    def generate_binary_tree(height):
        ...
        vertexes = [0 for i in range(num_nodes)]
        dfg_edges = []
        count  = 0
        fifo = [0]
    ...
    #     while not all_square_pes_contains_node(placement_c2n,pe,square) or any_out_of_border(pe,square,len(placement_c2n)):
    #         pe = choice(placement_c2n.keys())
    #         square = choice(squares)
