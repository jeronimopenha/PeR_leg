...
data_files = Util.get_files_list_by_extension(Util.get_project_root() + "/results_michael/", ".dot")
...
statistics_generator.write_df_to_csv(df, Util.get_project_root() + "/results_michael/", 'statistics_base_michael.csv')
