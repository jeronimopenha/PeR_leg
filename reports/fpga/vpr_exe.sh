...
for file in "$input_dir"/*_k6*; do
    ...
    if [ -f "$file" ]; then
        ...
        bin/vpr "$file" "arch/k6-n1.xml" "vpr_reports/fast/${filename_no_ext}_place.txt" "vpr_reports/fast/${filename_no_ext}_route.txt" -nodisp  > "vpr_reports/fast/${filename_no_ext}.txt"
